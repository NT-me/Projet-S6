...
MainWindow::MainWindow(QWidget *parent):QMainWindow(parent),ui(new Ui::MainWindow), grapheCourant("courant"){
  ...
  // QObject::connect(ui->actionEnrengistrer,&QAction::triggered,this, &MainWindow::;
  // QObject::connect(ui->actionEnrengistrer_sous,&QAction::triggered,this, &MainWindow:: ;
  QObject::connect(ui->actionDupliquer_graphe,&QAction::triggered,this, &MainWindow::Dupliquer_graphe) ;
  // QObject::connect(ui->actionSupprimer_graphe,&QAction::triggered,this, &MainWindow:: ;
